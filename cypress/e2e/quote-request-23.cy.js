describe('Quote Request 23 - Stratos Jet Charters, Inc.', () => {
  ...
  it('Quote Request: Response Code Verification', () => {
    cy.request('GET', 'https://www.stratosjets.com/quote-request-23/?utm_source=test').then((response) => {
      expect(response.status).to.eq(200)
    })
  })

  it('Quote Request: Form Test', () => {
    cy.visit('https://www.stratosjets.com/quote-request-23/?utm_source=test')
