describe('The 200 Busiest Airports in the US | Stratos Jet Charters, Inc.', () => {
  ...
  it('Busiest US Airports Blog: Response code verification', () => {
    cy.request('GET', 'https://www.stratosjets.com/blog/busiest-us-airports/?utm_source=test').then((response) => {
      expect(response.status).to.eq(200)
    })
  })

  it('Should navigate to the homepage when breadcrumb is clicked', () => {
    cy.visit('https://www.stratosjets.com/blog/busiest-us-airports/?utm_source=test');
    cy.viewport(1920, 1080)
    cy.wait(2000)
    cy.get('img[src="https://www.stratosjets.com/wp-content/themes/stratos/images/home-grey.svg"]').should('be.visible').click({force:true})
    cy.url().should('eq', 'https://www.stratosjets.com/');
    });

  it('Busiest US Airports Blog: Form Test', () => {
    cy.visit('https://www.stratosjets.com/blog/busiest-us-airports/?utm_source=test')
    cy.viewport(1920, 1080)
