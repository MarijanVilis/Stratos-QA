describe('New York Charter Jets | Charter Flights NYC | Stratos Jet Charters', () => {
      ...
      it('Single Flight: Response Code Verification', () => {
        cy.request('GET', 'https://www.stratosjets.com/jet-charter-flights/new-york-city/?utm_source=test').then((response) => {
          expect(response.status).to.eq(200)
        })
      })

      it('Should navigate to the homepage when breadcrumb is clicked', () => {
        cy.visit('https://www.stratosjets.com/jet-charter-flights/new-york-city/?utm_source=test');
